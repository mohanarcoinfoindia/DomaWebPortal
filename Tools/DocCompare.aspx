<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DocCompare.aspx.vb" Inherits="Tools_DocCompare" %>
    ...
    <asp:ScriptManager ID="sc1" runat="server"></asp:ScriptManager>
       ...
       <radS:RadPane ID="radPaneNavigation" runat="server" Height="30px" Scrolling="none">
         ...
         <radS:RadPane ID="radPaneContent" runat="server" Scrolling="None" >
             ...
             <radS:RadPane ID="radPaneLeftFile" runat="server" Scrolling="Y" Width="50%" Collapsed="false"/>
            <radS:RadSplitBar ID="radSplitbarTree" runat="server" CollapseMode="Both"  />
            <radS:RadPane ID="radPaneRightFile" runat="server" Scrolling="Y" Width="50%" Collapsed="false"/>
            </radS:RadSplitter>
         </radS:RadPane>
    </radS:RadSplitter>
    </form>
