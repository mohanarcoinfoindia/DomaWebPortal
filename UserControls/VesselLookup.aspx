<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VesselLookup.aspx.vb" Inherits="UserControls_VesselLookup" MasterPageFile="~/masterpages/Toolwindow.master" %>
...
function Select(num){
	...
	MainPage().GetContentWindow().AddValue<%=JSIdentifier %>(val,desc);
    UpdateYourSelection();
	<%if not mbMultiSelect or mbAutoSelect then%>
	SaveClose();
<%end if %>}
