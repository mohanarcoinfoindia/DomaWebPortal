<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PromptText.aspx.vb" Inherits="UserControls_PromptText" MasterPageFile="~/masterpages/Toolwindow.master"   %>

<asp:Content ID="Content1" ContentPlaceHolderID="Plh1" Runat="Server" MasterPageFile="~/masterpages/Toolwindow.master">
<script type="text/javascript">
    function SetPrompt() {
        var oWindow = GetRadWindow();       
        oWindow.argument = $get("<%=d1.ClientID %>").value;
        oWindow.Close();
    }
</script>
<div style="display: flex; justify-content: center;">
    <asp:Table ID="tbl" runat="server">
        <asp:TableRow>
            <asp:TableCell>
            <asp:TextBox MaxLength="2000" runat="server" ID="d1" TextMode="MultiLine" />
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow>
            <asp:TableCell>
