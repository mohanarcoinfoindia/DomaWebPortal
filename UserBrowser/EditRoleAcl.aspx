<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditRoleAcl.aspx.vb" Inherits="UserBrowser_EditRoleAcl" MasterPageFile="~/masterpages/Toolwindow.master" %>
    ...
    <div ID="tbl" runat="server" class="container-fluid detail-form-container mt-2">
        <div class="row detail-form-row">
            <div class="col FieldCell">
                <Arco:SelectSubject ID="newUser" runat="server" RefreshOnChange="true" UsersOnly="false" HideDeleteIcon="true" ShowRoleEveryone="false" />
            </div>
        </div>
